...
const Mint = () => {
  ...
  const saveData = async ({
    ...
    const uplodPrivetContent = await uploadFileToIpfs(fileContent.files);
    console.log("--privet content--->", uplodPrivetContent);
    ...
    if (file) {
      // const navBarLessRoutes = ["image/gif"];
      ...
      console.log("--img fingerpring-->", results);
      const metaData = {
        name: title,
        author: authorname,
        category: category,
